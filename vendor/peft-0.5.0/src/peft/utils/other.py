...
def _prepare_prompt_learning_config(peft_config, model_config):
    if peft_config.num_layers is None: # 32
    ...
    if peft_config.token_dim is None: # 4096
    ...
    if peft_config.num_attention_heads is None: # 32
    ...
    if getattr(peft_config, "encoder_hidden_size", None) is None: # 4096
