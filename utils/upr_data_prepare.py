...
@Time    :   2023/08/02 15:32:18
@Author  :   
@Version :   1.0
@Contact :   zpeng@scu.edu
@License :   None
@Desc    :   copy from https://github.com/DevSinghSachan/unsupervised-passage-reranking/blob/main/utils/download_data.py, remove the checkpoints, run this script by:

python utils/download_data.py --resource data --output_dir ./datasets/
'''
